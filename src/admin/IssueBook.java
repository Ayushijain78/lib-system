			...
			//ResultSet rs=db.getData(s1);
				...
				while( rs1.next() )
				{
					...
					p.print("<div class='card-footer'>");
						...
						p.print("<button type='button' class='btn btn-primary col-5'><a href=IssueForm?acc="+rs1.getString(4)+"><span class='text-light'>issue</span><a></button>");
						p.print("</div>");
					p.print("</div>");
				}
				p.print("</div>");
